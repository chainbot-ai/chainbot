...
namespace Plugins.Shared.Library.Librarys
{
    ...
    public class FormatOptions : IFormatOptions
    {
        ...
        public void Repalce()
        {
            try
            {
                ColumnSeparators = ColumnSeparators.
                    Replace("[space]", spaceSpe).Replace("[tab]", tabSpe).Replace("[newline]", newLineSpe);
        ...
        private string newLineSpe = Environment.NewLine;
        private string tabSpe = " \t";
        private string spaceSpe = " ";
