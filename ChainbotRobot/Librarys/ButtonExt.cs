...
namespace ChainbotRobot.Librarys
{
    ...
    public class ColorButtonThreeState : Button
    {
        ...
        public DrawingImage def_img
        {
            get { return (DrawingImage)GetValue(def_imgProperty); }
        ...
        public static readonly DependencyProperty def_imgProperty =
            DependencyProperty.Register("def_img", typeof(DrawingImage), typeof(ColorButtonThreeState), new PropertyMetadata(null));
