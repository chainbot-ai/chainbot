...
namespace ChainbotStudio.ViewModel
{
    ...
    public class RecentUsedProjectItemViewModel : ViewModelBase
    {
        ...
        /// </summary>
        public RecentUsedProjectItemViewModel(IProjectManagerService projectManagerService, IMessageBoxService messageBoxService
            , IRecentProjectsConfigService recentProjectsConfigService, ICommonService commonService)
        {
                ...
                return _openCommand
                    ...
                    async () =>
                    {
                        ...
                        if (_projectManagerService.CloseCurrentProject())
                        {
                            ...
                            if (!ret)
                            {
                                if (_messageBoxService.ShowQuestion(string.Format(Chainbot.Resources.Properties.Resources.Message_OpenRecentQuestion, ProjectConfigFilePath)))
                                {
        ...
        public RelayCommand OpenDirCommand
        {
            get
            {
                return _openDirCommand
                    ...
                    () =>
                    {
                        _commonService.LocateDirInExplorer(System.IO.Path.GetDirectoryName(ProjectConfigFilePath));
                    }));
            }
        }
