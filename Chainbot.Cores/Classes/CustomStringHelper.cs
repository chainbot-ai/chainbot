...
namespace Chainbot.Cores.Classes
{
    public static class CustomStringHelper
    {
        public static void Init()
        {
            ...
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.ParseErrorExpectingEndTag.ToString(), "应为结束标签 </{0}>。");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.ParseErrorMultipleRootElements‎.ToString(), "XML 文档不能包含多个根级别元素。");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.ParseErrorNoRootElement.ToString(), "XML 文档必须包含一个根级别元素。");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.ParseErrorNotExpectingEndTag‎.ToString(), "不应为 </{0}>。");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.ParseErrorTagNotClosed‎.ToString(), "标签未关闭。");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalCDataEndDelimiterErrorAlias‎.ToString(), "\"]]>\"");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalCDataStartDelimiterErrorAlias.ToString(), "\"<![CDATA[\"");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalCDataTextErrorAlias‎.ToString(), "CData 文本");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalCommentEndDelimiterErrorAlias‎.ToString(), "\"-->\"");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalCommentStartDelimiterErrorAlias‎.ToString(), "\"<!--\"");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalCommentTextErrorAlias‎.ToString(), "注释文本");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalDeclarationEndDelimiterErrorAlias.ToString(), "\">\"");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalDeclarationStartDelimiterErrorAlias‎.ToString(), "\"<!\"");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalDeclarationTextErrorAlias.ToString(), "声明文本");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalDocTypeDeclarationEndDelimiterErrorAlias‎.ToString(), "\">\"");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalDocTypeDeclarationInternalSubsetEndDelimiterErrorAlias‎.ToString(), "\"]\"");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalDocTypeDeclarationInternalSubsetStartDelimiterErrorAlias‎.ToString(), "\"[\"");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalDocTypeDeclarationInternalSubsetTextErrorAlias‎.ToString(), "声明文本");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalDocTypeDeclarationStartDelimiterErrorAlias‎.ToString(), "\"<!\"");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalEndTagEndDelimiterErrorAlias.ToString(), "\">\"");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalEndTagStartDelimiterErrorAlias‎.ToString(), "\"</\"");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalEndTagTextErrorAlias‎.ToString(), "结束标签名称");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalPIEndDelimiterErrorAlias‎.ToString(), "\"?>\"");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalPIStartDelimiterErrorAlias‎.ToString(), "\"<?\"");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalPITextErrorAlias.ToString(), "处理说明文本");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalStartTagAttributeNameErrorAlias‎.ToString(), "属性名称");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalStartTagAttributeValueEndDelimiterErrorAlias‎.ToString(), "属性结束值分隔符");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalStartTagAttributeValueStartDelimiterErrorAlias‎.ToString(), "属性起始值分隔符");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalStartTagAttributeValueTextErrorAlias‎.ToString(), "属性值");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalStartTagEndDelimiterErrorAlias‎.ToString(), "\">\" 或 \"/>\"");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalStartTagNameErrorAlias‎.ToString(), "开始标签名称");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalStartTagStartDelimiterErrorAlias.ToString(), "\"<\"");
            ActiproSoftware.Products.Text.Addons.Xml.SR.SetCustomString(ActiproSoftware.Products.Text.Addons.Xml.SRName.TerminalStartTagTextErrorAlias.ToString(), "开始标签文本");
