...
namespace Chainbot.Cores.Config
{
    public class RecentProjectsConfigService : IRecentProjectsConfigService
    {
        ...
        public RecentProjectsConfigService(IPathConfigService pathConfigService, IProjectConfigFileService projectConfigFileService
        ...
        private bool Add(string projectConfigFilePath,string projectName,string projectDescription)
        {
            ...
            var path = _pathConfigService.RecentProjectsXml;
            doc.Load(path);
            var rootNode = doc.DocumentElement;

            var projectNodes = rootNode.SelectNodes("Project");

            if (projectNodes.Count > _constantConfigService.RecentProjectsMaxRecordCount)
            {
