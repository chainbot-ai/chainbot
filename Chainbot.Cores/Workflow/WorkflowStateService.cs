...
namespace Chainbot.Cores.Workflow
{
    public class WorkflowStateService : MarshalByRefServiceBase, IWorkflowStateService
    {
        ...
        public event EventHandler<string> CheckDocumentExistEvent;
        ...
        public void RaiseCheckDocumentExistEvent(string workflowFilePath)
        {
            CheckDocumentExistEvent?.Invoke(this, workflowFilePath);
        }
    }
}
