...
namespace Chainbot.Cores.Workflow
{
    public class WorkflowDebugService : IWorkflowDebugService
    {
        ...
        public WorkflowDebugService(ILogService logService, IWorkflowStateService workflowStateService
            ...
            , IWorkflowBreakpointsServiceProxy workflowBreakpointsServiceProxy)
        {
            ...
            _workflowBreakpointsServiceProxy = workflowBreakpointsServiceProxy;
        ...
        private void _workflowStateService_BreakpointsModifyEvent(object sender, EventArgs e)
        {
            ...
            _breakpointIdJsonArray = _workflowBreakpointsServiceProxy.GetBreakpointSetting().ToString();
        ...
        private void _controller_CompleteEvent(string id, bool has_exception)
        {
            ...
            StopwatchStop();
            _logService.Debug(string.Format("End debugging workflow files {0}", _xamlPath), _logger);
        }
        ...
        private void _controller_ShowCurrentLocationEvent(string id, string location_id, string workflowFilePath)
        {
            if (!_workflowStateService.IsRunningOrDebugging)
            {
                return;
            ...
            _workflowStateService.RaiseCheckDocumentExistEvent(workflowFilePath);

            _workflowDesignerServiceProxy.ShowCurrentLocation(location_id, workflowFilePath);
        }
        ...
        private void _controller_HideCurrentLocationEvent(string id, string workflowFilePath)
        {
            _workflowDesignerServiceProxy.HideCurrentLocation(workflowFilePath);
        }
        ...
        private void StopwatchRestart()
        {
            ...
            SharedObject.Instance.Output(SharedObject.enOutputType.Information, string.Format(Chainbot.Resources.Properties.Resources.Message_StartDebug, _projectManagerService.CurrentProjectJsonConfig.name));
        }
        ...
        private void StopwatchStop()
        {
            ...
            SharedObject.Instance.Output(SharedObject.enOutputType.Information, string.Format(Chainbot.Resources.Properties.Resources.Message_EndDebug, _projectManagerService.CurrentProjectJsonConfig.name, elapsedTime));
        }
        ...
        public void Debug()
        {
            ...
            {
                _logService.Debug(string.Format("Start debugging workflow files {0} ……", _xamlPath), _logger);
        ...
        public void Stop(string workflowFilePath)
        {
            SetNextOperate(enOperate.Null);
            _controller_HideCurrentLocationEvent("", workflowFilePath);
            _controller.Stop(_guid);
            _controller_CompleteEvent(_guid, false);
        }
